...
describe("Determinism", () => {
  ...
  it("should not have any un-exempted Math.random calls", () => {
    const output = execSync(
      "grep -r 'Math.random()' -l codex/core codex/runtime codex/server --exclude-dir=node_modules --exclude-dir=immunity 2>/dev/null | grep -v -e 'opponent.engine.js' -e 'sonicStationBuckets.js' -e 'wordLookupPipeline.js' -e 'captcha.service.js' -e 'sqliteWriteQueue.js' || true"
    ).toString();
