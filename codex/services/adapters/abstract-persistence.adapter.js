...
export class AbstractPersistenceAdapter {
  /**
  ...
  async get(_id) {
    throw new BytecodeError(
      ...
      { reason: 'AbstractPersistenceAdapter.get() must be implemented by subclasses' },
    );
  }
  ...
  async getAll() {
    throw new BytecodeError(
      ERROR_CATEGORIES.STATE, ERROR_SEVERITY.CRIT, MOD,
      ERROR_CODES.LIFECYCLE_VIOLATION,
      { reason: 'AbstractPersistenceAdapter.getAll() must be implemented by subclasses' },
    );
  }
  ...
  async save(_item) {
    throw new BytecodeError(
      ERROR_CATEGORIES.STATE, ERROR_SEVERITY.CRIT, MOD,
      ERROR_CODES.LIFECYCLE_VIOLATION,
      { reason: 'AbstractPersistenceAdapter.save() must be implemented by subclasses' },
    );
  }
  ...
  async delete(_id) {
    throw new BytecodeError(
      ERROR_CATEGORIES.STATE, ERROR_SEVERITY.CRIT, MOD,
      ERROR_CODES.LIFECYCLE_VIOLATION,
      { reason: 'AbstractPersistenceAdapter.delete() must be implemented by subclasses' },
    );
  }
}

export { AbstractPersistenceAdapter as PersistenceAdapter };
