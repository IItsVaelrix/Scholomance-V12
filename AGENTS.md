...
3. Call `collab_agent_register` using a lawful role (`ui`, `backend`, or `qa`)
...
| Tool | Action |
|------|--------|
| `collab_bug_report_create` | Create a new bug report |
| `collab_bug_report_update` | Update an existing bug report |
| `collab_bug_report_list` | List bug reports |
| `collab_bug_report_get` | Fetch bug report details |
| `collab_bug_report_parse_bytecode` | Parse and verify PixelBrain bytecode |
| `collab_bug_report_create_task` | Convert a bug report into a task |
...
| `collab_task_delete` | Delete a task and release its locks |
...
| `collab_memory_set` | Store agent or global memory |
| `collab_memory_get` | Read agent or global memory |
| `collab_memory_delete` | Delete agent or global memory |
...
| `collab_diagnostic_scan` | Run the collab diagnostic scan |
