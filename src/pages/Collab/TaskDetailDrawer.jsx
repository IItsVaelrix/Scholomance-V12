            ...
            return (
              <div key={idx} className="file-row">
                <div className="file-path-group">
                  ...
                  {lock?.mcp_active && (
                    <span className="mcp-binding-badge" title="MCP Direct-Bind Active">
                      <ZapIcon size={10} /> MCP
                    </span>
                  )}
                </div>
        ...
        <div className="lock-table">
          ...
          {locks.map((lock, idx) => (
            <div key={idx} className="lock-row">
              ...
              <span className="lock-mode">
                {lock.mcp_stream ? (
                  <span className={`stream-indicator stream-indicator--${lock.mcp_stream.type}`}>
                    {lock.mcp_stream.type.toUpperCase()}
                  </span>
                ) : (
                  <span className="lock-mode--standard">LOCK</span>
                )}
              </span>
