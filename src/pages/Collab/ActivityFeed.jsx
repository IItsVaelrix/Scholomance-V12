...
const ACTION_LABELS = {
    ...
    pipeline_ingested: 'ingested experience',
    pipeline_corroborating: 'corroborating experience',
                ...
                {activity.map(entry => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {entry.action === 'pipeline_ingested' && (
                                <span className="activity-entry__experience-chip activity-entry__experience-chip--active">
                                    ✦ {entry.details?.bytecode?.slice(0, 12)}...
                                </span>
                            )}
                            {entry.action === 'pipeline_corroborating' && (
                                <span className="activity-entry__experience-chip activity-entry__experience-chip--pending">
                                    ◇ {entry.details?.bytecode?.slice(0, 12)}...
                                </span>
                            )}
                            {entry.details?.title && (
