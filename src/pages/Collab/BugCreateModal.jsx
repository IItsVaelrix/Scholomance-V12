            ...
            >
                ...
                >
                    ...
                    <form onSubmit={handleSubmit} style={{ padding: '20px', overflowY: 'auto', flex: 1, display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        ...
                        {error && (
                            <div style={{ 
                                color: isBytecode(error) ? 'var(--color-collab-info)' : 'var(--color-collab-error)', 
                                fontSize: '11px', 
                                padding: '10px', 
                                background: 'rgba(0, 0, 0, 0.2)', 
                                border: `1px solid ${isBytecode(error) ? 'var(--color-collab-info)' : 'var(--color-collab-error)'}`,
                                borderRadius: '4px', 
                                display: 'flex', 
                                flexDirection: 'column',
                                gap: '4px' 
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                    <ErrorIcon size={16} /> 
                                    <strong style={{ fontSize: '9px' }}>{isBytecode(error) ? 'BYTECODE ERROR DETECTED' : 'SUBMISSION ERROR'}</strong>
                                </div>
                                <code style={{ 
                                    wordBreak: 'break-all', 
                                    opacity: 0.9, 
                                    fontFamily: 'var(--font-collab-mono)',
                                    fontSize: isBytecode(error) ? '10px' : '11px'
                                }}>
                                    {error}
                                </code>
                            </div>
