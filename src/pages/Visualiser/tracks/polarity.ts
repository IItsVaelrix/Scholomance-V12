...
export const POLARITY: GrimoireTrack = {
  ...
  coverUrl: 'https://cdn2.suno.ai/video_gen_0ff1c2ee-6951-4f65-9204-4cbb2baf16fa_video_upload_cover_snapshot_image.jpeg',
  meta: [
    ['Duration', '4:14'],
    ['Persona', 'Vaelrix'],
  ...
  provenance: {
    ...
    assistance: 'Cinematic rap music video for Polarity',
  },
  lyrics: [
    ...
    "agony Parker, killing Ben, my tragedy darker ugh",
    ...
    "POLARITY",
    "POLARITY",
    "Polarity won't bury me, flow merrily over the beat",
    "while concurrently, flamethrower the heat",
    "composed an elite scheme with Dovakhin fleets",
    "blowing the streets off like scraping cement with the focus and speech",
    "demonic reach, tectonic stride",
    "psychotic thief, bionic eyes that glow like red fireflies",
    "Body is a coral reef, dead and gray",
    "color always fades Wonder always breaks",
    "til I'm trapped, banging on the wonderwall",
    "thundering disdain, bludgeoning the veins",
    "with a pickaxe, scraping at the wrist fat",
    "left arm covered in more scars than skin cells",
    "Sardonic Intel, Bardock with this skill",
    "birthing vigor, words delivering a sickle cell anemia",
    "this little hell I'm leaving ya will rip you up",
    "Bodies love to pile into towers when I step inside the booth",
    "weapons I produce leaving them shocked, pursuing truth",
    "Truthful Rubix Cube, Voodoo oozing through the microphone",
    "Stream of consciousness became a YouTube View",
    "I'll never see it though",
    "Views rising, still have the same fucking episodes",
    "let me go and die inside the road of recovery",
    "and be a statue for the dead",
    "Grappling with death",
    "having been the same since I killed my inner child",
    "bludgeoning an axe through his fucking neck",
    "Disrespect isn't this",
    "I am large, I'm the negative charge, I'm Eclipse",
    "body is stiff, logically dense",
    "I wanna die, I wanna be fixed",
    "I want to live, it is what it is",
    "A symptom of negative, get the hint",
    "Disrespect isn't this",
    "I am large, I'm the negative charge, I'm Eclipse",
    "body is stiff, logically dense",
    "I wanna die, I wanna be fixed",
