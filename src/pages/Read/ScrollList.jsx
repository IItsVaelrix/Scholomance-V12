      ...
      <div className="scroll-item-actions">
        ...
        {pendingDelete ? (
          <div className="scroll-delete-confirm" role="group" aria-label="Confirm deletion">
            <span className="scroll-delete-confirm-label">Delete?</span>
            <button
              type="button"
              className="scroll-delete-confirm-yes"
              onClick={(e) => { e.stopPropagation(); onDelete(scroll.id); setPendingDelete(false); }}
              aria-label="Confirm delete scroll"
            >Yes</button>
            <button
              type="button"
              className="scroll-delete-confirm-no"
