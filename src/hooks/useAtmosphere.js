 ...
 * 
 * @param {object} [overrides] - Optional adaptive overrides.
 * @param {object} [overrides.blendedHsl] - Blended HSL from adaptive palette.
 * @param {string} [overrides.dominantSchool] - Dominant school ID from adaptive palette.
 */
export function useAtmosphere(overrides = {}) {
  ...
  useEffect(() => {
    ...
    // Priority: Overridden Dominant School > Detected School (Sonic Energy) > Active ambient station > Active song (Watch) > Last selected ambient > Default
  ...
  }, [currentSong?.school, ambientState, auroraLevelState, detectedId, overrides.blendedHsl, overrides.dominantSchool]);
}
