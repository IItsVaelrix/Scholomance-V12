/**
 * Phaser WebGL PostFXPipeline for "chestplate harness energize" (item.void.chestplate.arcane.v1.harness.energize)
 * Generated deterministically from Scholomance custom shader packet.
 */
export class ItemVoidChestplateArcaneV1HarnessEnergizePipeline extends Phaser.Renderer.WebGL.Pipelines.PostFXPipeline {
  constructor(game) {
    super({
      game,
      name: 'item.void.chestplate.arcane.v1.harness.energize',
...
const float ENGRAVING_DENSITY = 0.0755;
