/**
 * Phaser WebGL PostFXPipeline for "chestplate void armor breath" (item.void.chestplate.sovereign.v1.void-armor-breath)
 * Generated deterministically from Scholomance custom shader packet.
 */
export class ItemVoidChestplateSovereignV1VoidArmorBreathPipeline extends Phaser.Renderer.WebGL.Pipelines.PostFXPipeline {
  constructor(game) {
    super({
      game,
      name: 'item.void.chestplate.sovereign.v1.void-armor-breath',
...
// Foundry void-armor-breath shader — void.chestplate.sovereign.v1.
// Mask-aware armor material shader with deterministic fBm + domain warping.
// Geometry AMP hash: fnv1a_E5B714D1.
...
const vec3 VOID_TINT = vec3(0.1961, 0.0627, 0.4275);
