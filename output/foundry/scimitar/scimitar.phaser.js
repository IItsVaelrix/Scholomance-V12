/**
 * Phaser WebGL PostFXPipeline for "scimitar blade energize" (item.scimitar.hd.v1.blade.energize)
 * Generated deterministically from Scholomance custom shader packet.
 */
export class ItemScimitarHdV1BladeEnergizePipeline extends Phaser.Renderer.WebGL.Pipelines.PostFXPipeline {
  constructor(game) {
    super({
      game,
      name: 'item.scimitar.hd.v1.blade.energize',
