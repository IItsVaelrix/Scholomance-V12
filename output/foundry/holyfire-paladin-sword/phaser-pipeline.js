/**
 * Phaser WebGL PostFXPipeline for "sword void armor breath" (item.paladin.holyfire.sword.v1.void-armor-breath)
 * Generated deterministically from Scholomance custom shader packet.
 */
export class ItemPaladinHolyfireSwordV1VoidArmorBreathPipeline extends Phaser.Renderer.WebGL.Pipelines.PostFXPipeline {
  constructor(game) {
    super({
      game,
      name: 'item.paladin.holyfire.sword.v1.void-armor-breath',
