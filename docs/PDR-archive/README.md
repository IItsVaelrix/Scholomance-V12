...
| [`ritual_prediction_enhancement_pdr.md`](./ritual_prediction_enhancement_pdr.md) | Prediction + VerseIR + PixelBrain + Infrastructure | Draft | High |
...
| [`mcp_infrastructure_hardening_pdr.md`](./mcp_infrastructure_hardening_pdr.md) | Infrastructure + Resilience + MCP | **Implemented** | High |
| [`adaptive_palette_pdr.md`](./adaptive_palette_pdr.md) | UI + Color Engine + Codex Contract | Draft | High |
| [`truesight_surface_remediation_pdr.md`](./truesight_surface_remediation_pdr.md) | Rendering + Runtime + UI + Performance | In Progress | Critical |
| [`zero_cost_infrastructure_pdr.md`](./zero_cost_infrastructure_pdr.md) | Infrastructure + DevOps + Cost Optimization | Draft | High |
| [`grimdesign_pdr.md`](./grimdesign_pdr.md) | UI + Tooling + PixelBrain + VerseIR + DX | Draft | High |
...
| [`thorough_ai_combat_pdr.md`](./thorough_ai_combat_pdr.md) | Combat + AI + VerseIR + UI | ✅ Yes | Canonical combat scoring and deterministic counter-verse convergence |
...
*Last Updated: 2026-04-18 — Added ritual_prediction_enhancement_pdr.md*
